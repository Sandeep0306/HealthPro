    ...
    <div className="container px-4 mx-auto">
      <div className="-mx-4 flex flex-wrap justify-between">
        <div className="px-4 my-4 w-full xl:w-1/5">
          ...
          With a blend of advanced healthcare prediction and comprehensive mental health care.
HealthPro is your trusted partner in achieving a healthier,happier life. Join us today and take control of your well-being like never before.     </p>
        </div>
        ...
        <div className="px-4 my-4 w-full sm:w-auto">
          ...
          <ul className="leading-8">
            ...
            <li>
              <a href="#" className="hover:text-blue-400">
              excepturi nesciunt iusto nobis
              </a>
            </li>
            <li>
              <a href="#" className="hover:text-blue-400">
    ...
    <div className="container mx-auto px-4">
      <div className="-mx-4 flex flex-wrap justify-between">
        <div className="px-4 w-full text-center sm:w-auto sm:text-left">
          Copyright © 2023 HealthPro. All Rights Reserved.
        </div>
        <div className="px-4 w-full text-center sm:w-auto sm:text-left">
          Made with ❤️ by Caffinated Coder's.
        </div>
      </div>
    </div>
  </div>
